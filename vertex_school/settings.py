"""
Django settings for vertex_school project.
...
SECRET_KEY = 'django-insecure-$54o-4z$8-4!49$^avv42clqckoq2^_4+^gtjna8jz7905+am!'
...
WSGI_APPLICATION = 'vertex_school.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,                  # Автоматическая ротация рефреш-токенов
